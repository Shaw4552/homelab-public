...
This document defines the logical topology of the network, including site layout, core components, and traffic flow between systems.
...
Each network segment represents a defined trust boundary:
...
* no direct exposure of internal services to external networks
...
This topology provides a clear, structured view of how network components interact while maintaining segmentation, security, and controlled connectivity across the environment.
