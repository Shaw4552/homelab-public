...
The design follows least-privilege and zero-trust principles to enforce security boundaries and minimize lateral movement across the network.
...
The policy distinguishes between two traffic types:

### North-South Traffic

- traffic between internal networks and the internet
...
- secure remote-access connections where required
...
- support ongoing migration and segmentation improvements